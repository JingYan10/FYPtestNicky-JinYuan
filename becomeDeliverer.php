...
<!--link to css-->
<link rel="stylesheet" href="becomeDeliverer.css">

<!--content here-->

<section class="singUp-form">
    <div class="center">
        <h1>Become Deliverer</h1>
        <form action="includes/becomeDeliverer.inc.php" method="post" enctype="multipart/form-data">
            <div class="txt_field">
            ...
            <div class="txt_field">
                <p>driving license photocopy (only accept in .pdf format) </p>
