...
<section class="editProduct-form">
    <div class="center">
        <h1>Edit Product</h1>
        <form action="includes/editProduct.inc.php" method="post" enctype="multipart/form-data">
            ...
            <div class="txt_field">
                <input type="text" name="productName" value=<?php echo $_SESSION['productName']; ?> required>
                <span></span>
            ...
            <div class="txt_field">
                <input type="text" name="productQuantity" value=<?php echo $_SESSION['productQuantity']; ?> required>
                <span></span>
                <label>Product quantity</label>
            </div>
            <div class="txt_field">
                <input type="text" name="productPrice" value=<?php echo $_SESSION['productPrice']; ?> required>
                <span></span>
